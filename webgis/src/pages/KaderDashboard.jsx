...
export default function KaderDashboard() {
    ...
    return (
        <div className="bg-background text-on-background font-body-md antialiased flex h-screen overflow-hidden">
            ...
            <aside className="print:hidden w-64 bg-surface border-r border-outline-variant/30 hidden md:flex flex-col z-40 shadow-sm">
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
                ...
                {/* --- MOBILE HEADER --- */}
                <header className="print:hidden md:hidden bg-surface/90 backdrop-blur-md border-b border-outline-variant/50 sticky top-0 z-40 py-4 px-4 flex items-center justify-between">
